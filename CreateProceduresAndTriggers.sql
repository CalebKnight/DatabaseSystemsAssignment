...
IF EXISTS DROP TRIGGER FESTIVAL_RUNTIME_TRIGGER;
...
IF EXISTS DROP TRIGGER YEAR_TRIGGER;

CREATE TRIGGER YEAR_TRIGGER BEFORE INSERT ON FILM FOR 
EACH ROW BEGIN 
...
IF EXISTS DROP TRIGGER ADD_FILM;
...
IF EXISTS DROP TRIGGER ADD_FESTIVAL;
...
IF EXISTS DROP TRIGGER FESTIVAL_DELETE_TRIGGER;
...
IF EXISTS DROP TRIGGER VENUE_UPDATE_TRIGGER;
